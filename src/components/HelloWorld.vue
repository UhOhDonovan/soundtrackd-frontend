...
<template>
  <div class="card">
    ...
    <div class="row justify-content-center" v-if="username == ''">
      <RouterLink to="/login" class="col-2 button"> Login </RouterLink>
      <br />
      <RouterLink to="/register" class="col-2 button"> Register </RouterLink>
    ...
    <div v-else>
      <h2 style="font-weight: 400">
        <RouterLink to="/search">Search for an album</RouterLink> to get started
